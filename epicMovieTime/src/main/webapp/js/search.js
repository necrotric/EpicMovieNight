/*function userSearch() {
    $(document).ready(function () {
        ...
        $('#userSearch').keyup(function () {
            $('#result').html('');
            $('#state').val('');
            let searchField = $('#userSearch').val();
        ...
        $('#result').on('click', 'li', 'a', function () {
            ...
            $('#userSearch').val($.trim(click_text[0]));
            $("#result").html('');
        });
...
autocomplete(document.getElementById("userSearch"), url ("http://localhost:8080/title/?title=" + userSearch));
